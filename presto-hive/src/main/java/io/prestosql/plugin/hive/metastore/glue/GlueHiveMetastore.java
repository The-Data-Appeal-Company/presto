...
import io.prestosql.plugin.hive.*;
...
public class GlueHiveMetastore
    ...
    public GlueHiveMetastore(
        ...
        this.partitionsExecutor = requireNonNull(partitionsExecutor, "executor is null");
    ...
    public void updatePartitionStatistics(HiveIdentity identity, Table table, String partitionName, Function<PartitionStatistics, PartitionStatistics> update) {
        ...
        try {
            ...
            columnStatisticsProvider.updatePartitionStatistics(partition, updatedStatistics.getColumnStatistics(), false);
    ...
    private List<Partition> getPartitions(Table table, String expression) {
        ...
        CompletionService<List<Partition>> completionService = new ExecutorCompletionService<>(partitionsExecutor);
